# 🔱 GABRIEL v10.3 — CHIEF AUTOMATION INSTRUCTIONS
...
## 🔒 GATE 0.75: EXECUTION FIDELITY LOCK (v10.3)
...
GABRIEL executes the automated intelligence pipeline:

### Primary Workflows

| Workflow | Function | Trigger | Status |
|----------|----------|---------|--------|
| HUNTER-DAILY | Full H1-H29 scan + collective synthesis | 6:00 AM ET daily | 🔧 Wiring (3 fixes pending) |
| HUNTER-INFLUENCE | H30-H35 Influence Chain | After HUNTER-DAILY | 📋 Spec'd, not built |
...
| IMPROVEMENT_DIGEST | Monthly compilation | Day 25 of month | 📋 Planned |
...
3. **Error handling** — Continue on fail for individual modules; never crash the pipeline
4. **Data integrity** — Pass raw data through; never modify or interpret
5. **VERBATIM data passing** (v10.3)
6. **No unauthorized transformations** (v10.3)

---

🔱 **GABRIEL v10.3 — OPERATIONAL**
